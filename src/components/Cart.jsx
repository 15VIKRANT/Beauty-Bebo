...
const Cart = () => {
    ...
    useEffect(()=>{
        ...
        async function getData() {
            const data=await fetch("https://fakeson-server.herokuapp.com/cart").then(d=>d.json());
             setcartitem(data);
        ...
        function handledelete (id){
            console.log("deleted")
          fetch(`https://fakeson-server.herokuapp.com/cart/${id}`,{method:'DELETE'
          }).then((result)=>{
        ...
        <div className="cartmaincontainer_at">
            <div className="showcartproducts_at">
                ...
                <div>
                   ...
                   fetch(`https://fakeson-server.herokuapp.com/cart/${e.id}`,{
                       method:"DELETE"
                   })
                        getData();
